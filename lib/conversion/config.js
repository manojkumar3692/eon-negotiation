...
export function defaultConversion(){return {
 step:0,strategy:'balanced',shipping:{mode:'connector',costMinor:null,chargeMinor:0,thresholdMinor:0},
 ...
 triggers:{enabled:true,minVisits:3,minDwellSeconds:120,minCartMinor:50000,lowStock:2,excludeNewLaunch:true,cooldownHours:24,checkoutHesitation:true,returningCustomer:true,recovery:true,campaign:''},
...
export const conversionSchema=z.object({
 step:z.number().int().min(0).max(7),strategy:z.enum(['protect_margin','balanced','maximize_conversion','clear_inventory']),
